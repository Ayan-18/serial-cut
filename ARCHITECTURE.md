...
- `application/characters.py` хранит локальную библиотеку персонажей и устойчивые привязки голосовых кластеров к именам.
- `media/character_recognition.py` консервативно сравнивает лица с локальными фотографиями; неоднозначные совпадения отбрасываются.
...
- Face tracking сохраняет сглаженные keyframes; Stage 4 превращает их во временное FFmpeg crop-выражение для плавного движения кадра.
