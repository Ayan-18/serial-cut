...
кандидату для проверки границ, кадра и субтитров. На этом этапе сохраняется именно план монтажа;
multi-source FFmpeg-склейка будет следующим отдельным шагом.
